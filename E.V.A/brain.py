...
LISTENING_SOUND = AudioSegment.from_wav("Ama.wav")
...
def listen():
  ...
  with sr.Microphone() as source: 
    ...
    print("brain>> ", voice_data.lower()) # print what user saidprint
    if voice_data:
...
def check_commands(command_text):
  ...
  return False
# 0============================
# def falar_mensagem(commands):
#     engine = pyttsx3.init()
#     engine.say(commands)
#     engine.runAndWait()

# # Ler o arquivo JSON com a mensagem
# with open('commands.json', 'r') as f:
#     data = json.load(f)
#     mensagem = data['boa tarde eva']

# # Chamar a função para falar a mensagem
